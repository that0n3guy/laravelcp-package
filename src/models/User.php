...
use Carbon\Carbon;
use Gcphost\Laravelcp\Models\UserProfile;
/**
 * I did not namespace this class since it makes things easier
 * and because we are using confide/entrust.
 */
...
class User extends ConfideUser {
    ...
    {
        return $this->hasMany('Gcphost\Laravelcp\Models\UserProfile');
    }

	public function notes()
    {
        return $this->hasMany('Gcphost\Laravelcp\Models\UserNotes');
    }

	public function assignedroles()
    {
        return $this->hasMany('Gcphost\Laravelcp\Models\AssignedRole');
    }
	public function posts()
    {
        return $this->hasMany('Gcphost\Laravelcp\Models\Post');
    }
